  ...
  return (
    <div className='flex items-center w-full gap-4 whitespace-nowrap p-2 flex-grow mx-4'>
        ...
        <ArrowLeft onClick={toggle}/>
            ...
            <input  autoFocus type="search" placeholder='Search' className=' pl-7 rounded-md w-full px-3 py-1 bg-[#edf3f8] focus: border-black border-[3px] focus:border-2 hover:border-2 outline-none ' />
